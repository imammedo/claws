...
export ENCHANT_MODULE_PATH="$bundle_lib"
...
PYTHONPATH="$bundle_lib/python2.7:$bundle_lib/python2.7/site-packages:$bundle_lib/python2.7/site-packages/gtk-2.0:$PYTHONPATH"
export PYTHONPATH
...
exec "$bundle_contents/MacOS/claws-mail-bin"
